...
public class Maximum_Subarray {
	 ...
	 * sum. To solve this problem in O(n), two varibles are needed: (1) curSum:
	 * the sum of subarray while traverse through the array; (2) maxSum: the max
	 * of all sums of subarrays.
	 */
